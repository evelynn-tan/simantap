...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        ...
        <!-- Elemen uji Tailwind -->
        <div class="p-8 m-8 bg-blue-500 text-white text-2xl font-bold rounded-lg shadow-lg text-center">
            Tailwind CSS Aktif 🎨
        </div>
    </body>
</html>
<?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views\welcome.blade.php ENDPATH**/ ?>