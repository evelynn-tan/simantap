...
<?php $__env->startSection('title', 'Edit Profil - SIMANTAP'); ?>
<?php $__env->startSection('page-title', 'Edit Profil Pegawai BPS'); ?>
<?php $__env->startSection('page-subtitle', 'Kelola profil dan keamanan akun Anda'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('pegawai.edit-profil.update')); ?>" method="POST" id="formProfil">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $pegawai->nama_lengkap)); ?>"
                                       class="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition <?php $__errorArgs = ['nama_lengkap'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="text-red-500 text-xs mt-1 flex items-center gap-1"><i class="fas fa-exclamation-circle"></i> <?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e($pegawai->nip); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="jabatan" value="<?php echo e(old('jabatan', $pegawai->jabatan)); ?>"
                                       class="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition <?php $__errorArgs = ['jabatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="divisi" value="<?php echo e(old('divisi', $pegawai->divisi)); ?>"
                                       class="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition <?php $__errorArgs = ['divisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('pegawai.edit-profil.update')); ?>" method="POST" id="formPassword">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="current_password" id="current_password"
                                           class="w-full px-4 py-3 pr-12 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="password" id="new_password"
                                           class="w-full px-4 py-3 pr-12 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col items-center mb-6">
                        <div class="relative group">
                            ...
                            <?php else: ?>
                                <div class="w-32 h-32 bg-gradient-to-br from-orange-400 to-yellow-500 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-lg border-4 border-purple-200" id="avatarInitial">
                                    <?php echo e(strtoupper(substr($pegawai->nama_lengkap, 0, 1))); ?><?php echo e(strtoupper(substr(explode(' ', $pegawai->nama_lengkap)[1] ?? '', 0, 1))); ?>
                        ...
                        <p class="text-sm text-slate-600 font-medium mt-3"><?php echo e($pegawai->nama_lengkap); ?></p>
                        <p class="text-xs text-slate-400"><?php echo e($pegawai->jabatan); ?></p>
                    </div>

                    
                    <form action="<?php echo e(route('pegawai.edit-profil.update')); ?>" method="POST" enctype="multipart/form-data" id="formFoto">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                    ...
                    <?php if($pegawai->foto): ?>
                    <form action="<?php echo e(route('pegawai.edit-profil.update')); ?>" method="POST" class="mt-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <div class="bg-gradient-to-br from-slate-700 to-slate-900 px-6 py-8 text-center relative">
                    ...
                    <div class="relative">
                        ...
                        <?php endif; ?>
                        <h3 class="text-lg font-bold text-white mt-3"><?php echo e($pegawai->nama_lengkap); ?></h3>
                        <p class="text-slate-300 text-sm"><?php echo e($pegawai->jabatan); ?></p>
                ...
                <div class="p-5 space-y-3">
                    <div class="flex justify-between items-center py-2 border-b border-slate-100">
                        ...
                        <span class="text-sm font-semibold text-slate-800 font-mono"><?php echo e($pegawai->nip); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-slate-100">
                        <span class="text-sm text-slate-500 flex items-center gap-2">
                            <i class="fas fa-envelope text-slate-400"></i> Email
                        </span>
                        <span class="text-xs font-medium text-slate-800"><?php echo e(Auth::user()->email); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-slate-100">
                        <span class="text-sm text-slate-500 flex items-center gap-2">
                            <i class="fas fa-building text-slate-400"></i> Divisi
                        </span>
                        <span class="text-sm font-medium text-slate-800"><?php echo e($pegawai->divisi); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-2">
                        <span class="text-sm text-slate-500 flex items-center gap-2">
                            <i class="fas fa-calendar text-slate-400"></i> Bergabung
                        </span>
                        <span class="text-sm font-medium text-slate-800"><?php echo e(Auth::user()->created_at->format('d M Y')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-lg p-5 text-white">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-lg"><?php echo e(\App\Models\Pengajuan::where('pegawaiID', $pegawai->pegawaiID)->count()); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-emerald-100 text-sm">Disetujui</span>
                        <span class="font-bold text-lg text-emerald-200"><?php echo e(\App\Models\Pengajuan::where('pegawaiID', $pegawai->pegawaiID)->where('status', 'disetujui')->count()); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-emerald-100 text-sm">Menunggu</span>
                        <span class="font-bold text-lg text-yellow-200"><?php echo e(\App\Models\Pengajuan::where('pegawaiID', $pegawai->pegawaiID)->where('status', 'menunggu')->count()); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.pegawai-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views\pegawai\edit-profil.blade.php ENDPATH**/ ?>