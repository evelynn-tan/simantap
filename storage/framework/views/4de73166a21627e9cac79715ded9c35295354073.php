...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - SIMANTAP'); ?></title>
            ...
            <div class="h-full flex flex-col" style="font-family: 'Poppins', sans-serif;">
                ...
                <div class="px-3 py-4 lg:py-5 overflow-y-auto flex-1 bg-gradient-to-b from-blue-900 to-blue-950 scrollbar-hide">
                    <ul class="space-y-1.5 lg:space-y-2 font-medium text-sm">
                        <!-- Dashboard -->
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.permintaan.index')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.permintaan.*') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <!-- Data Barang -->
                        <li>
                            <a href="<?php echo e(route('admin.barang.index')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.barang.index') || (request()->routeIs('admin.barang.*') && !request()->routeIs('admin.barang.create')) ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <!-- Tambah Barang -->
                        <li>
                            <a href="<?php echo e(route('admin.barang.create')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.barang.create') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <!-- Stock Opname -->
                        <li>
                            <a href="<?php echo e(route('admin.stock-opname.index')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.stock-opname.*') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <!-- Manajemen Pengguna -->
                        <li>
                            <a href="<?php echo e(route('admin.pengguna.index')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.pengguna.*') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
                        ...
                        <!-- Laporan -->
                        <li>
                            <a href="<?php echo e(route('admin.laporan.index')); ?>" @click="sidebarOpen = false" class="flex items-center px-3 lg:px-4 py-2.5 lg:py-3 text-blue-100 rounded-lg transition duration-200 <?php echo e(request()->routeIs('admin.laporan.*') ? 'bg-blue-700 border-l-4 border-yellow-400 shadow-lg text-white' : 'hover:bg-blue-800 border-l-4 border-transparent hover:text-white'); ?>">
            ...
            <header class="bg-white shadow-sm border-b border-slate-200 z-10 sticky top-0">
                <div class="flex justify-between items-center px-3 sm:px-4 lg:px-6 py-3 lg:py-4">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 lg:gap-4">
                        ...
                        <img src="<?php echo e(asset('images/logo-bps.png')); ?>" alt="Logo BPS" class="h-8 sm:h-10 lg:h-12 w-auto hidden sm:block">
                        ...
                        <div class="min-w-0">
                            <h2 class="text-sm sm:text-lg lg:text-2xl font-bold text-slate-800 leading-tight truncate" style="font-family: 'Poppins', sans-serif;">
                                <?php echo $__env->yieldContent('header', 'Dashboard Admin'); ?>
                            </h2>
                            <p class="text-[10px] sm:text-xs lg:text-sm text-slate-500 mt-0.5 hidden sm:block truncate"><?php echo $__env->yieldContent('subtitle', 'Selamat datang di SIMANTAP'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
                        <div class="text-right">
                            <div class="text-xs sm:text-sm lg:text-lg font-semibold text-slate-900 truncate max-w-[80px] sm:max-w-[120px] lg:max-w-none"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                            <div class="text-[10px] sm:text-xs lg:text-sm text-slate-600 hidden sm:block capitalize"><?php echo e(Auth::user()->role ?? 'Operator'); ?></div>
                        </div>
                        <!-- Avatar -->
            ...
            <main class="w-full flex-grow p-3 sm:p-4 lg:p-6">
                ...
                <?php if(session('success')): ?>
                    <div class="mb-3 sm:mb-4 lg:mb-6 p-3 sm:p-4 bg-green-50 border border-green-200 rounded-xl text-green-800 alert-auto-hide">
                        <p class="font-semibold text-xs sm:text-sm lg:text-base">✅ <?php echo e(session('success')); ?></p>
                    </div>
                <?php endif; ?>

                <?php if(session('error')): ?>
                    <div class="mb-3 sm:mb-4 lg:mb-6 p-3 sm:p-4 bg-red-50 border border-red-200 rounded-xl text-red-800 alert-auto-hide">
                        <p class="font-semibold text-xs sm:text-sm lg:text-base">❌ <?php echo e(session('error')); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('warning')): ?>
                    <div class="mb-3 sm:mb-4 lg:mb-6 p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-xl text-yellow-800 alert-auto-hide">
                        <p class="font-semibold text-xs sm:text-sm lg:text-base">⚠️ <?php echo e(session('warning')); ?></p>
                    </div>
                <?php endif; ?>
...
</html><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views\layouts\admin.blade.php ENDPATH**/ ?>