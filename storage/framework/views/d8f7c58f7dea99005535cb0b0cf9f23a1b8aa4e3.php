        ...
        <div class="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <form method="GET" action="<?php echo e(route('pegawai.monitor-permintaan')); ?>" class="flex flex-wrap items-center gap-2">
                    ...
                    <input type="date" name="tanggal_mulai" value="<?php echo e(request('tanggal_mulai')); ?>" class="px-3 py-2 border-0 rounded-lg text-sm text-slate-700">
                    <span class="text-white/70">-</span>
                    <input type="date" name="tanggal_selesai" value="<?php echo e(request('tanggal_selesai')); ?>" class="px-3 py-2 border-0 rounded-lg text-sm text-slate-700">
