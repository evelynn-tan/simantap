...
<?php $__env->startSection('title', 'Data Barang - SIMANTAP'); ?>
<?php $__env->startSection('header', 'Data Barang'); ?>
<?php $__env->startSection('subtitle', 'Kelola master data barang inventaris'); ?>
...
<div class="space-y-6" style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow-sm border border-blue-200 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-1"><?php echo e($totalBarang); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl shadow-sm border border-green-200 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-900 mt-1"><?php echo e($totalKategori); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl shadow-sm border border-red-200 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-red-900 mt-1"><?php echo e($barangHabis); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl shadow-sm border border-yellow-200 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-900 mt-1"><?php echo e($stokRendah); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200">
        <div class="px-6 py-5 border-b border-slate-200 flex justify-between items-start sm:items-center flex-col sm:flex-row gap-4">
            ...
            <a href="<?php echo e(route('admin.barang.create')); ?>" class="inline-flex items-center px-5 py-2.5 bg-blue-600 text-white hover:bg-blue-700 rounded-lg font-semibold text-sm transition duration-200 whitespace-nowrap">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                >
                    ...
                    <?php $__currentLoopData = $kategoriList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kategori->categoryID); ?>"><?php echo e($kategori->nama_kategori); ?></option>
            ...
            <table class="w-full text-sm" id="barangTable">
                ...
                <tbody id="barangTableBody" class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50 transition barang-row" 
                        data-nama="<?php echo e(strtolower($barang->namaBarang)); ?>" 
                        data-kode="<?php echo e(strtolower($barang->kode_barang ?? '')); ?>" 
                        data-kategori="<?php echo e($barang->categoryID); ?>"
                        data-status="<?php echo e($barang->status); ?>"
                    >
                        <td class="px-4 sm:px-6 py-4 font-mono font-bold text-slate-800 text-sm"><?php echo e($barang->kode_barang); ?></td>
                        <td class="px-4 sm:px-6 py-4 font-medium text-slate-800"><?php echo e($barang->namaBarang); ?></td>
                        <td class="hidden sm:table-cell px-4 sm:px-6 py-4 text-slate-700"><?php echo e($barang->kategori->nama_kategori ?? '-'); ?></td>
                        <td class="hidden md:table-cell px-4 sm:px-6 py-4 text-slate-700"><?php echo e(ucfirst($barang->satuan)); ?></td>
                        <td class="px-4 sm:px-6 py-4 text-center font-bold text-slate-800" data-value="<?php echo e($barang->stok ?? 0); ?>"><?php echo e($barang->stok ?? 0); ?></td>
                        <td class="px-4 sm:px-6 py-4 text-center" data-value="<?php echo e($barang->status); ?>">
                            <?php if($barang->status === 'habis'): ?>
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex gap-2 justify-center">
                                <button 
                                    type="button"
                                    onclick="openEditModal(<?php echo e($barang->barangID); ?>, '<?php echo e($barang->kode_barang); ?>', '<?php echo e(addslashes($barang->namaBarang)); ?>', <?php echo e($barang->categoryID); ?>, '<?php echo e($barang->satuan); ?>', <?php echo e($barang->stok); ?>, '<?php echo e(addslashes($barang->deskripsi ?? '')); ?>')"
                                ...
                                <button 
                                    type="button"
                                    onclick="openDeleteModal(<?php echo e($barang->barangID); ?>, '<?php echo e(addslashes($barang->namaBarang)); ?>')"
        ...
        <div class="px-6 py-3 bg-slate-50 border-t border-slate-200 flex justify-between items-center text-sm text-slate-600">
            <span id="tableInfo">Menampilkan <strong><?php echo e($totalBarang); ?></strong> barang</span>
...
function filterTable() {
    ...
    // Update table info
    document.getElementById('tableInfo').innerHTML = `Menampilkan <strong>${visibleCount}</strong> dari <strong><?php echo e($totalBarang); ?></strong> barang`;
}
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views/admin/barang/index.blade.php ENDPATH**/ ?>