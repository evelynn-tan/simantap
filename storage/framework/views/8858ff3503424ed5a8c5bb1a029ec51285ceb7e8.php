                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex items-center gap-2 sm:gap-3">
                            <button type="button" @click="decrementJumlah()" 
                                    class="w-14 h-14 sm:w-12 sm:h-12 bg-slate-200 hover:bg-slate-300 rounded-lg flex items-center justify-center text-slate-700 transition text-2xl sm:text-lg font-bold flex-shrink-0">
                            ...
                            <input 
                                ...
                                class="flex-1 min-w-0 text-center text-2xl font-bold border border-slate-200 rounded-lg px-2 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                            >
                            <button type="button" @click="incrementJumlah()" 
                                    class="w-14 h-14 sm:w-12 sm:h-12 bg-emerald-500 hover:bg-emerald-600 rounded-lg flex items-center justify-center text-white transition text-2xl sm:text-lg font-bold flex-shrink-0">
                                <span class="font-bold">+</span>
                            </button>
                        </div>
