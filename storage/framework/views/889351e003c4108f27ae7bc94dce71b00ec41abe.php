    ...
    <div class="container">
        <div class="card">
                    ...
                    <div class="error-alert">
                        <ul>
                            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><i class="fas fa-circle-exclamation"></i> <?php echo e($error); ?></li>
                ...
                <form id="tambahPenggunaForm" action="<?php echo e(route('admin.pengguna.store')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role" required onchange="togglePegawaiFields()">
                            <option value="pegawai" <?php echo e(old('role', 'pegawai') === 'pegawai' ? 'selected' : ''); ?>>Pegawai BPS</option>
                            <option value="operator" <?php echo e(old('role') === 'operator' ? 'selected' : ''); ?>>Operator BMN</option>
                        </select>
                    </div>
            ...
            <div class="card-footer">
                <a href="<?php echo e(route('admin.pengguna.index')); ?>" class="btn-cancel">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views\admin\pengguna\create.blade.php ENDPATH**/ ?>