...
<?php $__env->startSection('title', 'Dashboard Pegawai - SIMANTAP'); ?>
        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between">
            <div class="flex-1">
                <div class="flex items-center gap-4 mb-4">
                    <div class="h-16 w-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/20">
                        <span class="text-2xl font-bold"><?php echo e(strtoupper(substr($pegawai->nama_lengkap, 0, 1))); ?><?php echo e(strtoupper(substr(explode(' ', $pegawai->nama_lengkap)[1] ?? '', 0, 1))); ?></span>
                    </div>
                    <div>
                        <p class="text-emerald-200 text-sm font-medium">Selamat Datang Kembali 👋</p>
                        <h1 class="text-2xl md:text-3xl font-extrabold"><?php echo e($pegawai->nama_lengkap); ?></h1>
                    </div>
                </div>
                <p class="text-emerald-100 text-sm md:text-base flex items-center gap-2">
                    <i class="fas fa-building"></i>
                    <?php echo e($pegawai->jabatan); ?> • <?php echo e($pegawai->divisi); ?>
            ...
            <div class="mt-4 md:mt-0 flex flex-col items-start md:items-end gap-2">
                <div class="bg-white/15 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20">
                    <p class="text-xs text-emerald-200">📅 <?php echo e(\Carbon\Carbon::now()->locale('id')->translatedFormat('l, d F Y')); ?></p>
                </div>
                <div class="bg-white/15 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 group animate-fade-in-up" style="animation-delay: 0.1s">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800 mt-2 group-hover:text-emerald-600 transition"><?php echo e($barangDigunakan); ?></h3>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300 group animate-fade-in-up" style="animation-delay: 0.2s">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800 mt-2 group-hover:text-blue-600 transition"><?php echo e($totalPermintaan); ?></h3>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg hover:border-amber-200 transition-all duration-300 group animate-fade-in-up <?php echo e($menungguPersetujuan > 0 ? 'animate-pulse-slow' : ''); ?>" style="animation-delay: 0.3s">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Menunggu</p>
                <h3 class="text-4xl font-extrabold text-slate-800 mt-2 group-hover:text-amber-600 transition"><?php echo e($menungguPersetujuan); ?></h3>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg hover:border-purple-200 transition-all duration-300 group animate-fade-in-up" style="animation-delay: 0.4s">
        ...
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-extrabold text-slate-800 mt-2 group-hover:text-purple-600 transition"><?php echo e($approvalRate); ?>%</h3>
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">Statistik bulanan tahun <?php echo e(date('Y')); ?></p>
                </div>
            </div>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col">
        ...
        <div class="mt-4 grid grid-cols-3 gap-2 text-center text-xs">
            <div class="p-2 bg-emerald-50 rounded-lg">
                <span class="block text-lg font-bold text-emerald-600"><?php echo e($statusCounts['disetujui']); ?></span>
                <span class="text-slate-500">Disetujui</span>
            </div>
            <div class="p-2 bg-amber-50 rounded-lg">
                <span class="block text-lg font-bold text-amber-600"><?php echo e($statusCounts['menunggu']); ?></span>
                <span class="text-slate-500">Menunggu</span>
            </div>
            <div class="p-2 bg-red-50 rounded-lg">
                <span class="block text-lg font-bold text-red-600"><?php echo e($statusCounts['ditolak']); ?></span>
    ...
    <div class="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-xs bg-emerald-50 text-emerald-600 px-3 py-1.5 rounded-lg font-semibold">
                <?php echo e($barangSedangDigunakan->total()); ?> item
            </span>
        </div>
        ...
        <div class="overflow-x-auto flex-1">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm">
                    <?php $__empty_1 = true; $__currentLoopData = $barangSedangDigunakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="group hover:bg-emerald-50 transition-colors border-b border-slate-50 last:border-0">
                                <td class="py-3 font-medium text-slate-700">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="group-hover:text-emerald-700 transition"><?php echo e($detail->barang->namaBarang); ?></span>
                                    </div>
                                </td>
                                <td class="py-3 text-slate-600">
                                    <span class="font-bold"><?php echo e($detail->jumlah); ?></span> 
                                    <span class="text-xs text-slate-400"><?php echo e($detail->barang->satuan); ?></span>
                                </td>
                                <td class="py-3 text-slate-500"><?php echo e($pengajuan->created_at->format('d M Y')); ?></td>
                                <td class="py-3 text-slate-500 truncate max-w-[150px]"><?php echo e($pengajuan->description); ?></td>
                            </tr>
        ...
        <?php if($barangSedangDigunakan->hasPages()): ?>
        <div class="mt-4 pt-4 border-t border-slate-100">
            <?php echo e($barangSedangDigunakan->links()); ?>
...
<div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('pegawai.monitor-permintaan')); ?>" class="text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition flex items-center gap-1">
    ...
    <div class="overflow-x-auto rounded-xl border border-slate-100">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-100">
                <?php $__empty_1 = true; $__currentLoopData = $riwayatPermintaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $riwayat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $__currentLoopData = $riwayat->pengajuanDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-slate-600 font-medium whitespace-nowrap">
                            ...
                            <span class="block text-xs text-slate-400 font-normal"><?php echo e($riwayat->created_at->format('H:i')); ?></span>
                        </td>
                        <td class="px-6 py-4 text-sm text-slate-800 font-semibold"><?php echo e($detail->barang->namaBarang); ?></td>
                        <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($detail->jumlah); ?> <?php echo e($detail->barang->satuan); ?></td>
                        <td class="px-6 py-4">
                            <?php if($riwayat->status == 'menunggu'): ?>
                            ...
                            <?php elseif($riwayat->status == 'disetujui'): ?>
                        ...
                        <td class="px-6 py-4 text-sm text-slate-500 max-w-xs truncate"><?php echo e($riwayat->description); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
...
<div class="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl shadow-lg p-6 text-white">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="<?php echo e(route('pegawai.daftar-barang')); ?>" class="flex items-center gap-3 p-4 bg-white/10 hover:bg-white/20 rounded-xl transition group">
        ...
        <a href="<?php echo e(route('pegawai.monitor-permintaan')); ?>" class="flex items-center gap-3 p-4 bg-white/10 hover:bg-white/20 rounded-xl transition group">
        ...
        <a href="<?php echo e(route('pegawai.edit-profil')); ?>" class="flex items-center gap-3 p-4 bg-white/10 hover:bg-white/20 rounded-xl transition group">
        ...
        <a href="<?php echo e(route('pegawai.dashboard')); ?>" class="flex items-center gap-3 p-4 bg-white/10 hover:bg-white/20 rounded-xl transition group">
...
<script>
    ...
    new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Permintaan',
                data: <?php echo json_encode($bulanData, 15, 512) ?>,
                borderColor: '#10b981',
    ...
    new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($statusCounts['disetujui']); ?>,
                    <?php echo e($statusCounts['menunggu']); ?>,
                    <?php echo e($statusCounts['ditolak']); ?>
    ...
    new Chart(ctx3, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($topBarang->pluck('namaBarang'), 15, 512) ?>,
            datasets: [{
                label: 'Jumlah',
                data: <?php echo json_encode($topBarang->pluck('total'), 15, 512) ?>,
                backgroundColor: [
                    'rgba(59, 130, 246, 0.8)',
                    'rgba(16, 185, 129, 0.8)',
                    'rgba(139, 92, 246, 0.8)',
...
<?php echo $__env->make('layouts.pegawai-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views/pegawai/dashboard.blade.php ENDPATH**/ ?>