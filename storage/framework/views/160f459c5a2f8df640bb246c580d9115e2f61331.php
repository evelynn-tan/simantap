...
<?php $__env->startSection('title', 'Laporan - SIMANTAP'); ?>
<?php $__env->startSection('header', 'Pusat Laporan'); ?>
<?php $__env->startSection('subtitle', 'Kelola dan ekspor laporan pengajuan barang'); ?>
...
<div class="space-y-6" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div class="p-4 sm:p-5 lg:p-6">
            ...
            <!-- Form Laporan Umum -->
            <form id="form-umum" action="<?php echo e(route('admin.laporan.index')); ?>" method="GET" class="block">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 items-end">
                    <div>
                        ...
                        <input type="date" name="tanggal_mulai" value="<?php echo e(old('tanggal_mulai', request('tanggal_mulai'))); ?>" 
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_selesai" value="<?php echo e(old('tanggal_selesai', request('tanggal_selesai'))); ?>" 
                            class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">
                        ...
                        <select name="kategori_id" class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white">
                            ...
                            <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kategori->categoryID); ?>" <?php echo e((string)old('kategori_id', request('kategori_id')) === (string)$kategori->categoryID ? 'selected' : ''); ?>>
            ...
            <form id="form-pegawai" action="<?php echo e(route('admin.laporan.index')); ?>" method="GET" class="hidden">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 items-end">
                    <div>
                        ...
                        <select name="pegawai_id" class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white" required>
                            ...
                            <?php $__currentLoopData = $pegawais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pegawai->pegawaiID); ?>" <?php echo e((string)old('pegawai_id', request('pegawai_id')) === (string)$pegawai->pegawaiID ? 'selected' : ''); ?>>
                                    <?php echo e($pegawai->nama_lengkap); ?> (<?php echo e($pegawai->nip); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="periode" class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white">
                            <?php $selectedPeriode = old('periode', request('periode')); ?>
                            <option value="" <?php echo e($selectedPeriode == '' ? 'selected' : ''); ?>>Semua Waktu</option>
                            <option value="30" <?php echo e($selectedPeriode == '30' ? 'selected' : ''); ?>>30 Hari Terakhir</option>
                            <option value="90" <?php echo e($selectedPeriode == '90' ? 'selected' : ''); ?>>90 Hari Terakhir</option>
                            <option value="180" <?php echo e($selectedPeriode == '180' ? 'selected' : ''); ?>>6 Bulan Terakhir</option>
                            <option value="365" <?php echo e($selectedPeriode == '365' ? 'selected' : ''); ?>>1 Tahun Terakhir</option>
                        </select>
                    </div>
                    <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-lg transition flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
                        <i class="fas fa-search"></i> Generate Laporan
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 border-b border-slate-200 flex justify-between items-center">
            <div>
                ...
                <p class="text-green-100 text-sm mt-1">
                    Periode: <?php echo e(request('tanggal_mulai') ? \Carbon\Carbon::parse(request('tanggal_mulai'))->format('d M Y') : 'Awal'); ?> 
                    - <?php echo e(request('tanggal_selesai') ? \Carbon\Carbon::parse(request('tanggal_selesai'))->format('d M Y') : 'Sekarang'); ?>

                    | Total: <strong><?php echo e(count($hasilLaporanUmum)); ?></strong> pengajuan
                </p>
            </div>
            <?php if(count($hasilLaporanUmum) > 0): ?>
            <div class="flex gap-2">
                <a href="<?php echo e(route('admin.laporan.export-excel', request()->all())); ?>" 
                ...
                <a href="<?php echo e(route('admin.laporan.export-pdf', request()->all())); ?>" target="_blank"
                   class="inline-flex items-center px-4 py-2 bg-white/20 hover:bg-white/30 text-white font-semibold rounded-lg text-sm transition backdrop-blur-sm">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php $__currentLoopData = $hasilLaporanUmum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-6 py-4 font-semibold text-slate-800"><?php echo e($index + 1); ?></td>
                        <td class="px-6 py-4 font-semibold text-slate-800">
                            <?php echo e($pengajuan->approved_at ? $pengajuan->approved_at->timezone('Asia/Jakarta')->format('d M Y') : '-'); ?>

                        </td>
                        <td class="px-6 py-4">
                            <div class="font-medium text-slate-800"><?php echo e($pengajuan->nama_pegawai); ?></div>
                            <div class="text-xs text-slate-500"><?php echo e($pengajuan->nip); ?></div>
                        </td>
                            ...
                            <ul class="space-y-1">
                                <?php $__currentLoopData = $pengajuan->pengajuanDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex items-center gap-2">
                                        ...
                                        <?php echo e($detail->barang->namaBarang ?? 'Barang Tidak Ditemukan'); ?> 
                                        <span class="font-semibold text-blue-600">(<?php echo e($detail->jumlah ?? 0); ?> <?php echo e($detail->barang->satuan ?? 'unit'); ?>)</span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </td>
                        <td class="px-6 py-4 text-slate-700 max-w-xs">
                            <span class="line-clamp-2"><?php echo e($pengajuan->description ?? '-'); ?></span>
                        </td>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-purple-500 to-violet-600 border-b border-slate-200 flex justify-between items-center">
            <div>
                ...
                <?php if($selectedPegawai): ?>
                <p class="text-purple-100 text-sm mt-1">
                    Pegawai: <strong><?php echo e($selectedPegawai->nama_lengkap); ?></strong> (<?php echo e($selectedPegawai->nip); ?>)
                    | Total: <strong><?php echo e(count($hasilLaporanPegawai)); ?></strong> pengajuan disetujui
                </p>
                <?php endif; ?>
            </div>
            <?php if(count($hasilLaporanPegawai) > 0): ?>
            <div class="flex gap-2">
                <a href="<?php echo e(route('admin.laporan.export-excel', request()->all())); ?>" 
                   class="inline-flex items-center px-4 py-2 bg-white/20 hover:bg-white/30 text-white font-semibold rounded-lg text-sm transition backdrop-blur-sm">
                    <i class="fas fa-file-excel mr-2"></i> Excel
        ...
        <div class="px-6 py-4 bg-purple-50 border-b border-purple-100">
            <div class="flex items-center gap-4">
                <div class="h-14 w-14 bg-gradient-to-br from-purple-400 to-violet-500 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
                    <?php echo e(strtoupper(substr($selectedPegawai->nama_lengkap, 0, 1))); ?>

                </div>
                <div>
                    <h4 class="font-bold text-slate-800 text-lg"><?php echo e($selectedPegawai->nama_lengkap); ?></h4>
                    <div class="flex items-center gap-4 text-sm text-slate-600 mt-1">
                        <span><i class="fas fa-id-card mr-1 text-purple-500"></i> <?php echo e($selectedPegawai->nip); ?></span>
                        <span><i class="fas fa-briefcase mr-1 text-purple-500"></i> <?php echo e($selectedPegawai->jabatan); ?></span>
                        <span><i class="fas fa-building mr-1 text-purple-500"></i> <?php echo e($selectedPegawai->divisi); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php $__currentLoopData = $hasilLaporanPegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-6 py-4 font-semibold text-slate-800"><?php echo e($index + 1); ?></td>
                        <td class="px-6 py-4 font-semibold text-slate-800">
                            <?php echo e($pengajuan->approved_at ? $pengajuan->approved_at->timezone('Asia/Jakarta')->format('d M Y H:i') : '-'); ?>
                            ...
                            <ul class="space-y-1">
                                <?php $__currentLoopData = $pengajuan->pengajuanDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex items-center gap-2">
                                        ...
                                        <?php echo e($detail->barang->namaBarang ?? 'Barang Tidak Ditemukan'); ?> 
                                        <span class="font-semibold text-purple-600">(<?php echo e($detail->jumlah ?? 0); ?> <?php echo e($detail->barang->satuan ?? 'unit'); ?>)</span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </td>
                        ...
                        <td class="px-6 py-4 text-slate-700">
                            <?php echo e($pengajuan->approver->email ?? '-'); ?>
            ...
            <div class="flex items-center gap-6 text-sm">
                <div class="flex items-center gap-2">
                    ...
                    <strong class="text-purple-700">
                        <?php echo e($hasilLaporanPegawai->flatMap(fn($p) => $p->pengajuanDetails)->sum('jumlah')); ?> item
                    </strong>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-check-circle text-green-500"></i>
                    <span class="text-slate-600">Total Pengajuan Disetujui:</span>
                    <strong class="text-green-700"><?php echo e(count($hasilLaporanPegawai)); ?></strong>
                </div>
            </div>
        </div>
        <?php else: ?>
...
window.addEventListener('DOMContentLoaded', function() {
    const activeTab = '<?php echo e(old("jenis_laporan", request("jenis_laporan", "umum"))); ?>';
    switchTab(activeTab);
});
</script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE TINGKAT 3\SEMESTER 5\REKAYASA PERANGKAT LUNAK (RPL)\simantap\resources\views\admin\laporan\index.blade.php ENDPATH**/ ?>